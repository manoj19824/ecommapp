...
public class CategoryControllerTest {
    ...
    @SpyBean
    private CategoryResourceConverter resourceConverter;
    @MockBean
    ...
    public void testRetrieveAllCategories() throws Exception {
        ...
        Mockito.when(categoryService.getAllCategories()).thenReturn(Arrays.asList(category1, category2, category3));
